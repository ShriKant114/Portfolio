...
import leetcodeIcon from '../assets/icon/leetcodebw.svg';

export const Footer = ({ darkMode = false }) => {
  // Define colors for light/dark mode
  const color = darkMode ? '#f5f6f7' : '#1b1b32';

  return (
    <footer className="bg-color text-center py-4 w-full mb-3 mt-2">

      <div className="md:hidden flex justify-center space-x-6 my-6 gap-8">
        {/* GitHub */}
        <a
        ...
        {/* Twitter */}
      <a href="https://instagram.com" target="_blank" className="hover:scale-150 transition-transform duration-300">
